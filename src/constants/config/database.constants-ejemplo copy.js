 ...
 */
DatabaseConstants.HOST = "localhost";
/**
 * PORT DATABASE
 * puerto donde escucha la base de datos
 * por defecto: 5432
 */
DatabaseConstants.PORT_DATABASE = "5432";
/**
 * USER DATABASE
 * usuario de la base de datos
 * por defecto: root
 */
DatabaseConstants.USER_DATABASE = "root";
/**
 * PASSWORD DATABASE
 * contraseña de la base de datos
 */
DatabaseConstants.PASSWORD_DATABASE = "[EDITE AQUI]";
/**
 * NAME DATABASE
 * nombre de la base de datos
 */
DatabaseConstants.DATABASE = "[EDITE AQUI]";
