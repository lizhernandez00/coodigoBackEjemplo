                    ...
                    .then(response => {
                      if (response.length > 0) {
                        ...
                        return res.json({
                          ...
                          code: 204,
                          message:
                            "No se creó el registro en la tabla TOKENS pero si en Fiscal POP",
                          resultado: 0
                        });
                      }
                    })
            ...
            await db
                      ...
                      axios
                        ...
                        .catch(errorAxios => {
                          ...
                          return res.json({
                            status: "NOK",
                            message:
                              "La venta no tiene un id electronico (id transacion) válido para open pay",
              ...
              .catch(error => {
                ...
                return res.json({
                  ...
                  code: 500,
                  message:
                    "Ocurrió un error, no fue posible realizar la consulta"
                });
              });
          }
        })
