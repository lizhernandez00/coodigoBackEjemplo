...
class Mail extends constants_constants_1.Constants {
    constructor() {
        super();
        this.headerImg = 'https://openbis.com.mx/assets/encabezado_mail_openbis.jpg';
     ...
     * @param email
     */
    sendMailPaquete(email, tipo, id_usuario, nombre, link) {
        // Instancia de la clase server
        const server = server_class_1.Server.instanceServer;
        let htmlMessage = "";
     ...
     * @param email
     */
    sendMailPaqueteTarjeta(email, tipo, id_usuario, nombre, data, conceptos) {
        // Instancia de la clase server
        const server = server_class_1.Server.instanceServer;
        let htmlMessage = "";
        let total = 0;
